...
RSpec.describe Building::HabitatCentralControl do
  subject(:building) { described_class }

  it 'has the correct name' do
    expect(building.name).to eq('Habitat Central Control')
  end
  ...
  it 'requires 3 Energy and 5 Alloys' do
    expect(building.upkeep).to eq_resources({ energy: 3, alloys: 5 })
  end
end
